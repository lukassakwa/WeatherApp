...
public class LocationWeatherFragmentPresenter extends BasePresenter<ContractMVP.LocationWeatherFragmentView> implements ContractMVP.WeatherFragmentPresenter {
